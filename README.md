...
flowchart LR
  ...
  %% ===== REST CONTROLLERS =====
  RC_product["ProductRestController"]:::restController
  RC_user["UserRestController"]:::restController
  RC_order["OrderRestController"]:::restController
  RC_review["ReviewRestController"]:::restController
  RC_login["LoginRestController"]:::restController
  RC_location["LocationRestController"]:::restController
  RC_image["ImageRestController"]:::restController
  RC_charts["ChartsRestController"]:::restController
  RC_ticket["TicketRestController<br/>(utility-service)"]:::restController
  RC_mail["MailRestController<br/>(utility-service)"]:::restController
  ...
  S_mail["MailService"]:::service
  S_ticket["TicketService"]:::service
  S_charts["ChartsService"]:::service
  S_userLogin["UserLoginService"]:::service
  S_mailUtility["MailService<br/>(utility-service)"]:::service
  S_ticketUtility["TicketService<br/>(utility-service)"]:::service
  ...
  RC_login --> S_userLogin

  RC_location --> S_location

  RC_image --> S_image

  RC_charts --> S_charts

  RC_ticket --> S_ticketUtility
  RC_mail --> S_mailUtility
  ...
  classDef view fill:#d9c6e6,stroke:#8d6aa8,color:#2e1d36,stroke-width:1px;
  classDef controller fill:#cfe8c6,stroke:#79a56a,color:#1f3a17,stroke-width:1px;
  classDef restController fill:#d7f0d0,stroke:#4f9445,color:#12360f,stroke-width:2px;
  classDef service fill:#f1c9c9,stroke:#b06a6a,color:#4a1f1f,stroke-width:1px;
  classDef repo fill:#cfe0f5,stroke:#6d8fb1,color:#1f3550,stroke-width:1px;
  classDef entity fill:#ececec,stroke:#8b8b8b,color:#2b2b2b,stroke-width:1px;
...
Participated in the design and implementation of the REST API in app-service, creating several DTOs, MapStruct mappers and API endpoints. Added filtered search and product recommendations to API, JSON error responses, and moved ticket/PDF generation and email sending to a utility-service microservice via API communication. Also, prepared Docker build/publish scripts.

| Nº  |                                                                                               Commits                                                                                                |                                                                                                                                                                                                                                                                                                                                                                    Files                                                                                                                                                                                                                                                                                                                                                                    |
| :-: | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: | :-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: |
|  1  | [Add Order RestController. Set default responses for API exceptions. Update pom.xml with MapStruct plugin.](https://github.com/CodeURJC-SSDD-2025-26/practica-ssdd-2025-26-grupo-13/commit/c500060)  |                                    Mostly [app-service/src/main/java/es/mqm/webapp/controller/OrderRestController.java](https://github.com/CodeURJC-SSDD-2025-26/practica-ssdd-2025-26-grupo-13/blob/main/app-service/src/main/java/es/mqm/webapp/controller/OrderRestController.java), [app-service/src/main/java/es/mqm/webapp/controller/NoSuchElementExceptionControllerAdvice.java](https://github.com/CodeURJC-SSDD-2025-26/practica-ssdd-2025-26-grupo-13/blob/main/app-service/src/main/java/es/mqm/webapp/controller/NoSuchElementExceptionControllerAdvice.java), [app-service/pom.xml](https://github.com/CodeURJC-SSDD-2025-26/practica-ssdd-2025-26-grupo-13/blob/main/app-service/pom.xml)                                    |
|  2  |                    [Introduce JWT authentication and authorization for API. Minor fixes.](https://github.com/CodeURJC-SSDD-2025-26/practica-ssdd-2025-26-grupo-13/commit/a2a3f12)                    | Mostly [app-service/src/main/java/es/mqm/webapp/security/SecurityConfiguration.java](https://github.com/CodeURJC-SSDD-2025-26/practica-ssdd-2025-26-grupo-13/blob/main/app-service/src/main/java/es/mqm/webapp/security/SecurityConfiguration.java), [app-service/src/main/java/es/mqm/webapp/security/jwt/JwtTokenProvider.java](https://github.com/CodeURJC-SSDD-2025-26/practica-ssdd-2025-26-grupo-13/blob/main/app-service/src/main/java/es/mqm/webapp/security/jwt/JwtTokenProvider.java), [app-service/src/main/java/es/mqm/webapp/security/jwt/JwtRequestFilter.java](https://github.com/CodeURJC-SSDD-2025-26/practica-ssdd-2025-26-grupo-13/blob/main/app-service/src/main/java/es/mqm/webapp/security/jwt/JwtRequestFilter.java) |
|  3  |                 [Add search with filters in GET /api/v1/products/ through query parameters](https://github.com/CodeURJC-SSDD-2025-26/practica-ssdd-2025-26-grupo-13/commit/b49fb14)                  |                                                                                                                            Mostly [app-service/src/main/java/es/mqm/webapp/controller/ProductRestController.java](https://github.com/CodeURJC-SSDD-2025-26/practica-ssdd-2025-26-grupo-13/blob/main/app-service/src/main/java/es/mqm/webapp/controller/ProductRestController.java), [app-service/src/main/java/es/mqm/webapp/service/ProductService.java](https://github.com/CodeURJC-SSDD-2025-26/practica-ssdd-2025-26-grupo-13/blob/main/app-service/src/main/java/es/mqm/webapp/service/ProductService.java)                                                                                                                            |
|  4  |             [Move email and PDF generation to utility-service, adding communication through API](https://github.com/CodeURJC-SSDD-2025-26/practica-ssdd-2025-26-grupo-13/commit/c47da99)             |                      Mostly [utility-service/src/main/java/es/mqm/controller/TicketRestController.java](https://github.com/CodeURJC-SSDD-2025-26/practica-ssdd-2025-26-grupo-13/blob/main/utility-service/src/main/java/es/mqm/controller/TicketRestController.java), [utility-service/src/main/java/es/mqm/service/TicketService.java](https://github.com/CodeURJC-SSDD-2025-26/practica-ssdd-2025-26-grupo-13/blob/main/utility-service/src/main/java/es/mqm/service/TicketService.java), [app-service/src/main/java/es/mqm/webapp/service/TicketService.java](https://github.com/CodeURJC-SSDD-2025-26/practica-ssdd-2025-26-grupo-13/blob/main/app-service/src/main/java/es/mqm/webapp/service/TicketService.java)                      |
|  5  | [Add product recommendations endpoint, fix modification of users through API, create build/publish scripts.](https://github.com/CodeURJC-SSDD-2025-26/practica-ssdd-2025-26-grupo-13/commit/a52b265) |                                                   Mostly [app-service/src/main/java/es/mqm/webapp/controller/ProductRestController.java](https://github.com/CodeURJC-SSDD-2025-26/practica-ssdd-2025-26-grupo-13/blob/main/app-service/src/main/java/es/mqm/webapp/controller/ProductRestController.java), [app-service/src/main/java/es/mqm/webapp/controller/UserRestController.java](https://github.com/CodeURJC-SSDD-2025-26/practica-ssdd-2025-26-grupo-13/blob/main/app-service/src/main/java/es/mqm/webapp/controller/UserRestController.java), [docker/create_image.sh](https://github.com/CodeURJC-SSDD-2025-26/practica-ssdd-2025-26-grupo-13/blob/main/docker/create_image.sh)                                                   |
